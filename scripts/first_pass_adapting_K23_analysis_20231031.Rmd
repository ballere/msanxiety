...
tibble_overall_summaries_by_sex <- df_disease_burden_unc_and_anx_net_collapsed_variables %>% 
  ...
  #mean disease by anxiety dose: anxiety_dose  0.03606    0.01493   2.416   0.0162 *
  ...
  #volume lost in anxiety net by anxiety dose*sex: anxiety_dose         0.053407   0.021365   2.500   0.0129 *  
...
########UF R - just looking at uncinate by anxiety dose; anxiety_dose      369.72     187.93   1.967   0.0499 *  ***********
...
#factor
diagnosis_by_age_anx_net_gam_factor <- gam(proportion_volume_lost_anxiety_net_by_network_size_sum_top_25 ~ as.factor(anxiety_dose)+s(PAT_AGE_AT_EXAM, by = as.factor(anxiety_dose)), data = df_demo_and_fascicles_no_unclass_anxiety_dose, method = "REML")
...
diagnosis_by_age_nonanx_net_gam_factor <- gam(proportion_volume_lost_nonanxiety_net_by_network_size_sum_bottom_75 ~ as.factor(anxiety_dose)+s(PAT_AGE_AT_EXAM, by = as.factor(anxiety_dose)), data = df_demo_and_fascicles_no_unclass_anxiety_dose, method = "REML")
...
#factor
diagnosis_by_age_UF_R_gam_factor <- gam(UF_R_vol ~ as.factor(anxiety_dose)+s(PAT_AGE_AT_EXAM, by = as.factor(anxiety_dose)), data = df_demo_and_fascicles_no_unclass_anxiety_dose, method = "REML")
...
#factor
diagnosis_by_age_UF_L_gam_factor <- gam(UF_L_vol ~ as.factor(anxiety_dose)+s(PAT_AGE_AT_EXAM, by = as.factor(anxiety_dose)), data = df_demo_and_fascicles_no_unclass_anxiety_dose, method = "REML")
