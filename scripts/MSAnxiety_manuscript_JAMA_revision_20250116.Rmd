...
#(T = -3.2, P = 0.002, Cohen's f2 =  0.178, Effect size = medium)
...
#Fornix gam Diagnosis; DiagnosisMS+Anxiety    (T = 0.683, P = 0.496, Cohen's f2 =  0.024, Effect size = small)
...
df_demo_and_fascicles_no_unclass_anxiety_dose <- df_demo_and_fascicles %>%
  ...
  #gam, Fornix anxiety_dose   (T = 0.959, P = 0.338, Cohen's f2 =  0, Effect size = minimal)"
...
dep_mean_gam = summary(dep_mean_UF_gam_prop)$p.table[2,4]
