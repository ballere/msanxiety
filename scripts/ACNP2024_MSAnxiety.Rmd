...
#gam
fascicle_gam <- lapply(fascicle_names_w_prop_suffix, function(x) 
{
...
names(fascicle_gam) <- fascicle_names_w_prop_suffix
...
print(fascicle_anova_gam_fdr_p05) 
```
#### Parametric anxiety net fascicles -> needs GAM
...
#### Parametric nonanxiety net fascicles --> Needs gam
