...
make_demographics_table_ms_w_promis_anxiety(data_frame = df_people_with_promis_data_scores_added_unique[df_people_with_promis_data_scores_added_unique$oanxietydx_OR_meds_AND_Anxietydx.Meds.And.Dep.True.Healthy.Collapsed != "unclassified",])

make_demographics_table_ms_w_promis_anxiety(data_frame = df_people_with_promis_data_scores_added_unique[((df_people_with_promis_data_scores_added_unique$oanxietydx_OR_meds_AND_Anxietydx.Meds.And.Dep.True.Healthy.Collapsed != "unclassified") & (df_people_with_promis_data_scores_added_unique$oanxietydx_OR_meds_AND_Anxietydx.Meds.And.Dep.True.Healthy.Collapsed != "Has.Anxietydx.OR.Antianxiety.Meds")),])
