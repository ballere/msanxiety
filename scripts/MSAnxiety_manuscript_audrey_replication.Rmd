...
uncinate_lesions_dose_2 <- df_demo_and_fascicles_no_unclass_anxiety_dose %>% filter(has.uncinate.lesion == 1 & anxiety_dose == 2) %>% count() #n=19
...
anxiety_total_dose_2 <- df_demo_and_fascicles_no_unclass_anxiety_dose %>% filter(anxiety_dose == 2) %>% count() #n=23
