...
#X-squared (Pearson's) X-squared(2,371) = 0.059833, p = 0.9705
...
#X-squared(1,122) = 0.001529, p = 0.9688
...
##### healthy vs sick
#Fornix gam Diagnosis; DiagnosisMS+Anxiety    342.5      382.7   0.895   0.3726   = NS
...
df_demo_and_fascicles_no_unclass_anxiety_dose <- df_demo_and_fascicles %>%
  ...
  #gam, Fornix anxiety_dose    186.5      168.0   1.110    0.268  =NS
...
### print demographics, MS+noA = 96, MS+mildA = 248, MS+severeA=21
...
#bilateral UF ~ Diagnosis: DiagnosisMS+Anxiety    768.2      422.2   1.820   0.0715 .  trend, likely due to sample size
disease_mean_UF_vol_gam <- gam(mean_UF_vol ~ Diagnosis + osex+s(PAT_AGE_AT_EXAM, k = 4, fx = F), data = uncinate_by_dx_df)
summary(disease_mean_UF_vol_gam)
...
df_demo_and_fascicles_no_unclass_anxiety_dose <- df_demo_and_fascicles_no_steroids_or_ifn %>%
  ...
  #bilat anxiety dose + sex + age: anxiety_dose: anxiety_dose    369.9      189.7   1.949    0.052 . (trend, likely due to sample size)   
  anxietyGrouping_mean_UF_by_sex_gam <- gam(mean_UF_vol ~ anxiety_dose + osex + s(PAT_AGE_AT_EXAM, k = 4, fx = F), data=df_demo_and_fascicles_no_unclass_anxiety_dose)
  summary(anxietyGrouping_mean_UF_by_sex_gam)
